...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO teacher (name,gender,languages,email,mobile,password,date,caste,file)
        values('$name','$gender','$languages','$email','$mobile','$password','$date','$caste','$file')";
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="" class="form-control" placeholder="Enter Your Name" autocomplete="off" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="" class="form-control" placeholder="Enter Your email" autocomplete="off" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-group">
                                            <label for="" class="font-weight-bold">Mobile</label>
                                            <input type="tel" name="mobile" id="" class="form-control" placeholder="Enter Your Mobile Number" autocomplete="off" maxlength="10" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" id="" class="form-control" placeholder="Enter Your Password" autocomplete="off" required />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="" class="font-weight-bold">Date Of Birth</label>
                                            <input type="date" name="date" id="" class="form-control" placeholder="Enter Your DOB" autocomplete="off" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="form-check d-flex justify-content-start mb-4 pb-3 py-4">
                                    <input class="form-check-input me-3" type="checkbox" value="" id="" required />
