...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO student (name,email,position,password,gender)
        values('$name','$email','$position','$password','$gender')";
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" novalidate method="POST">
                            ...
                            <div class="col-md-12">
                                <input class="form-control" type="email" name="email" placeholder="E-mail Address" autocomplete="off" required>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <input type="radio" class="btn-check" name="gender" id="Other" value="Other" required>
